...
cpepDataset<-read.csv("../GlCoSy/SD_workingSource/cpepGGC.csv",stringsAsFactors = TRUE)
chiCheck<-read.csv("../GlCoSy/SD_workingSource/CHICheck.csv")
# merge with SD data
# diagnosisDataset<-read.csv("../GlCoSy/SDsource/diagnosisDateDeathDate.txt")
diagnosisDataset<-read.csv("../GlCoSy/SDsource/demogALL.txt", quote = "", 
                           row.names = NULL, 
